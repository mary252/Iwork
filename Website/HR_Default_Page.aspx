<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_Default_Page.aspx.cs" Inherits="HR_Default_Page" %>
   ...
   <asp:Button onclick="prev_requests" runat="server" Text="Prev. requests" CssClass="button" BackColor="#ccff99" BorderStyle="None" Font-Bold="true" Font-Size="16px" ForeColor="black"
    ...
    <asp:Button onclick="reply_mail" runat="server" Text="Reply mail" CssClass="button" BackColor="#ccff99" BorderStyle="None" Font-Bold="true" Font-Size="16px" ForeColor="black"
        ...
        <div>
            ...
            <br/>
            <asp:Button ID="btn_add_job" runat="server" Text="Add Job." onclick="add_job"/>

            <br/>
            <asp:Button ID="btn_veiw_edit_job" runat="server" Text="Edit exsisting job vacancies." onclick="veiw_edit_job"/>

		    <br/>
            <asp:Button ID="bbtn_veiw_appli" runat="server" Text="Veiw new applications." onclick="veiw_appli"/>

		    <br/>
            <asp:Button ID="btn_announce" runat="server" Text="Post announcements." onclick="announce"/>
				
			<br/>
            <asp:Button ID="btn_veiw_request" runat="server" Text="Veiw staff requests." onclick="veiw_request"/>

		    <br/>
            <asp:Button ID="btn_attend" runat="server" Text="Veiw staff attendance" onclick="attend"/>

            <br/>
            <asp:Button ID="btn_veiw_working_hours" runat="server" Text="Veiw staff working hours." onclick="veiw_working_hours"/>
				
            <br/>
            <asp:Button ID="btn_top_achivers" runat="server" Text="Veiw the top three achievers of the company." onclick="top_achivers"/>
