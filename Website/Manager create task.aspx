<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager create task.aspx.cs" Inherits="Manager_create_task" %>
            ...
            <div id="content">
					<div id="req" runat="server" class="box">
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align:left; padding-left:30px;">
                            <asp:Label ID="task" runat="server" Text="Task Name:" ></asp:Label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <br />
                        <asp:Label ID="dd" runat="server" Text="Deadline:" ></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="deadline" runat="server" TextMode="Date"></asp:TextBox>
                        
                        <br />
                        <asp:Label ID="taskdis" runat="server" Text="Task Description:" ></asp:Label> &nbsp;&nbsp;
                        <asp:TextBox ID="Taskdescription" runat="server" Width="200px" Height="100px"></asp:TextBox>
                ...
                <div style="margin-left: auto; margin-right: auto; text-align:left; padding-left:30px;">
                    ...
                    <asp:Button ID="create" runat="server" CssClass="button" OnClick="createproject" Text="Create" />
                    &nbsp;&nbsp;
                    <br />
