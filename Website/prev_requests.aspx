<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prev_requests.aspx.cs" Inherits="prev_requests" %>
        ...
        <div id="table_part">
            <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="table_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="request_date" HeaderText="Requesting date" ItemStyle-Width="150" />
