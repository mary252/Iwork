<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_my_attendance.aspx.cs" Inherits="view_my_attendance" %>
...
<div id="page-wrapper">
        ...
        <asp:Label ID="start" runat="server" Text="Start Time: "></asp:Label>
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="view" runat="server" Text="View" OnClick="vieww" />


        <div id="table_part">
            <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="table_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="start_time" HeaderText="checked in" ItemStyle-Width="150" />
                    <asp:BoundField DataField="end_time" HeaderText="checked out" ItemStyle-Width="180" />
                    <asp:BoundField DataField="duration" HeaderText="duration" ItemStyle-Width="150" />
                    <asp:BoundField DataField="missing hours in hrs" HeaderText="missing hours" ItemStyle-Width="180" />
                </Columns>
            </asp:GridView>
            </div>
             </div> 
