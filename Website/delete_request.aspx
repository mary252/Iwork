<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete_request.aspx.cs" Inherits="delete_request" %>
...
<div id="page-wrapper">
       ...
       <asp:Label ID="lab" runat="server" Text="please enter the start_date of the request you wish to delete and then press 'Delete' " CssClass="label" ForeColor="black"></asp:Label>
        <br />
    <asp:TextBox ID="txt_deleted" runat="server"></asp:TextBox>
     <br />
     <br />
        <div id="table_part">
            <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="table_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="request_start_date" HeaderText="Request start date" ItemStyle-Width="150" />
                    <asp:BoundField DataField="request_date" HeaderText="Request date" ItemStyle-Width="150" />
                    <asp:BoundField DataField="hr_response" HeaderText="HR response" ItemStyle-Width="180" />
                    <asp:BoundField DataField="manager_response" HeaderText="Manager response" ItemStyle-Width="180" />
                </Columns>
            </asp:GridView>
            </div>

     <asp:Button ID="deletee" runat="server" Text="Delete" onclick="delete" CssClass="button"/>
    <asp:Label ID="Labellog" runat="server" Text="" CssClass="label" ForeColor="Red"></asp:Label>
    </div>
    
<div id="copyright" class="container"">
    <ul class="contact" style="position:absolute; left:650px; bottom:-5px;" >
