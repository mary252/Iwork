<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_company.aspx.cs" Inherits="search_company" %>
<!DOCTYPE html>
...
<div id="page-wrapper" style="background-image:url(iWork.jpg); height: 862px;">
         ...
         <h1 style="color:black;">To search for a company, use any of these 3 options</h1>
            <br />
            <asp:Label ID="Lb_name" runat="server" Text="Company Name" Font-Size="X-Large"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="name_textbox" runat="server" style="margin-left: 16px" Width="204px"></asp:TextBox>
          <br />
            <br />
            <asp:label ID="lb_address" runat="server" Text="Address" Font-Size="X-Large"></asp:label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="text_address" runat="server" style="margin-left: 53px" Width="198px" ></asp:TextBox>
             <br />
            <br />
            <asp:Label ID="lb_type" runat="server" Text="Type" Font-Size="X-Large"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="text_type" runat="server" style="margin-left: 61px" Width="200px" ></asp:TextBox>
            <br />
      <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="search" runat="server" Text="Search"  OnClick="Search" Width="168px" Font-Size="X-Large" />
     <br />
     <br />
