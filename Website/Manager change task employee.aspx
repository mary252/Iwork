<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager change task employee.aspx.cs" Inherits="Manager_change_task_employee" %>
		...
		<div id="sidebar">
            ...
            <div id="content">
					<div id="req" runat="server" class="box">
                        ...
                        <br />
                        <br />
						<h2>Change Task's Regular Employee </h2>
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        <asp:Label ID="tasname" runat="server" Text="Task Name:" ></asp:Label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="margin-left: auto; margin-right: auto; text-align:left; padding-left:30px;">
                    ...
                    <asp:Button ID="assign" runat="server" CssClass="button" OnClick="assigntask" Text="Assign" />
                    &nbsp;&nbsp;
                    <br />
