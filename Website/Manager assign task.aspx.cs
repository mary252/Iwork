...
public partial class Manager_assign_task : System.Web.UI.Page
{
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("Manger_Assign_Regular_Employee_Task", conn);
                    ...
                    else
                    {
                        ...
                        {
                            status.Text = "This task doesn't exist ";
                        }
                        else
                        {
                            if (stat.Value.ToString().Equals("3"))
                            {
                                status.Text = "Task's Employee was Assignd ";
                            }
                            else
                            {
                                if (stat.Value.ToString().Equals("4"))
                                {
                                    status.Text = "This task is already assigned to someone else please go to change task employee to change him ";
                                }
                            }
                        }
                    }
