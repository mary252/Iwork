<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buisiness_request.aspx.cs" Inherits="buisiness_request" %>
...
<div id="page-wrapper">
        ...
        <asp:Label ID="start" runat="server" Text="Start Time: "></asp:Label>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="destination_box" runat="server" ></asp:TextBox>

            <br />
            <asp:label ID="purpose" runat="server" Text="Purpose: "></asp:label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="Purpose_textbox" runat="server" ></asp:TextBox>


            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="request1" runat="server" Text="Request" OnClick="requestt" />
