<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Veiw_And_Edit_Jobs.aspx.cs" Inherits="Veiw_And_Edit_Jobs" %>
...
<div id="page-wrapper">
	<div id="page">
        <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnRowCommand="Edit">
                <Columns>
                    ...
                    <asp:ButtonField ButtonType="Button" Text="Edit" CommandName="Edit" HeaderText="Edit" ItemStyle-Width="150" />
                </Columns>
            </asp:GridView>
