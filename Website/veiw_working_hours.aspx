<%@ Page Language="C#" AutoEventWireup="true" CodeFile="veiw_working_hours.aspx.cs" Inherits="veiw_working_hours" %>
...
<div id="page-wrapper">
	<div id="page">
        <br/>
            <asp:Label ID="lbl_staff" runat="server" Text="Staff Username:"></asp:Label>
            <asp:TextBox ID="txt_staff" runat="server"></asp:TextBox>
			...
			<br/>
            <asp:Button ID="btn_veiw" runat="server" Text="View" onclick="veiw"/>
