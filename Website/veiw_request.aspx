<%@ Page Language="C#" AutoEventWireup="true" CodeFile="veiw_request.aspx.cs" Inherits="veiw_request" %>
...
<div id="page-wrapper">
	<div id="page">
        <div>
            <br/>
            <asp:Button ID="btn_leave_requests" runat="server" Text="Leave Requests." onclick="view_leave"/>

            <br/>
            <asp:Button ID="btn_business_requests" runat="server" Text="Bussiness Requests." onclick="view_business"/>
