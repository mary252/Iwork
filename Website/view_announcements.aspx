<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_announcements.aspx.cs" Inherits="view_announcements" %>
...
<div id="page-wrapper">
        ...
        <div id="table_part">
            <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="table_SelectedIndexChanged">
                <Columns>
                    <asp:BoundField DataField="hr_employee" HeaderText="HR" ItemStyle-Width="150" />
                    <asp:BoundField DataField="announcement_date" HeaderText="Date" ItemStyle-Width="180" />
                    <asp:BoundField DataField="title" HeaderText="Title" ItemStyle-Width="150" />
                    <asp:BoundField DataField="announcement_description" HeaderText="Description" ItemStyle-Width="180" />
                </Columns>
            </asp:GridView>
            </div>
    </div>
