<%@ Page Language="C#" AutoEventWireup="true" CodeFile="business_requests.aspx.cs" Inherits="business_requests" %>
	...
	<div id="page" >
            ...
            <asp:GridView ID="table" runat="server" AutoGenerateColumns="false" OnRowCommand="tableCommand">
                <Columns>
                    ...
                    <asp:BoundField DataField="applicant" HeaderText="Applicant" ItemStyle-Width="180" />
                    <asp:BoundField DataField="request_end_date" HeaderText="Request end date" ItemStyle-Width="150" />
                    <asp:BoundField DataField="request_date" HeaderText="Request Date" ItemStyle-Width="180" />
                    <asp:BoundField DataField="total_days" HeaderText="Total number of Requested dates" ItemStyle-Width="150" />
                    ...
                    <asp:BoundField DataField="manager_reason" HeaderText="Manager Reasone" ItemStyle-Width="150" />
				    <asp:BoundField DataField="destination" HeaderText="Destination" ItemStyle-Width="150" />
				    <asp:BoundField DataField="purpose" HeaderText="Pusrpose" ItemStyle-Width="150" />
