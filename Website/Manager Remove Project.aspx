<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Manager Remove Project.aspx.cs" Inherits="Manager_Remove_Project" %>
		...
		<div id="sidebar">
            ...
            <div id="content">
					<div id="req" runat="server" class="box">
                        ...
                        <br />
                        <br />
						<h2>Remove Regular Employee to a Project</h2>
                        <br />
                        <br />
                ...
                <div style="margin-left: auto; margin-right: auto; text-align:left; padding-left:30px;">
                    ...
                    <asp:Button ID="assign" runat="server" CssClass="button" OnClick="assignproject" Text="Remove" />
                    &nbsp;&nbsp;
                    <br />
