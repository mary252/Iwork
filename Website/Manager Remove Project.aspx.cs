...
public partial class Manager_Remove_Project : System.Web.UI.Page
{
    ...
    protected void assignproject(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("Manager__Remove_Regular_employee_from_Project", conn);
                ...
                else
                {
                    ...
                    {
                        status.Text = "This employee is not assigned to this project";
                    }
                    else
                    {
                        if (stat.Value.ToString().Equals("3"))
                        {
                            status.Text = "Sorry The Employee has Tasks in this project";
                        }
                        else
                        {
                            if (stat.Value.ToString().Equals("4"))
                            {
                                status.Text = "Employee was removed successfully to the project";
                            }
                        }
                    }
                }
